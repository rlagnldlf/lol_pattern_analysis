...
추출된 독립변수들로 승률을 예측하기 위해 선형회귀 모델을 학습하여 결과로 회귀 계수와 절편을 출력해 예측값에 임계값을 적용해 이진 분류를 수행했다. 모델의 예측 정확도는 Accuracy와 AUROC로 평가하여 성능을 확인하기로 했는데 10개의 독립변수들을 5개까지 1개씩 지워 모델을 학습한 결과 
